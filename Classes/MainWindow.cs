...
namespace Kenedia.Modules.ItemDestructor
{
    public class Control_AddButton : Control
    {
        ...
        public Control_AddButton()
        {
            ...
            Add = ItemDestructor.TextureManager.getControlTexture(_Controls.Add);
            AddHovered = ItemDestructor.TextureManager.getControlTexture(_Controls.Add_Hovered);
            _EmptyTraitLine = ItemDestructor.TextureManager.getControlTexture(_Controls.PlaceHolder_Traitline).GetRegion(0, 0, 647, 136);
            _Template_Border = ItemDestructor.TextureManager.getControlTexture(_Controls.Template_Border);
    ...
    public class iTab : Panel
    {
        ...
        public iTab(Container parent)
        {
            ...
            Icon = ItemDestructor.TextureManager.getIcon(_Icons.Bug);
            LeftBar = ItemDestructor.TextureManager.getControlTexture(_Controls.TabBorderLeft);
            RightBar = ItemDestructor.TextureManager.getControlTexture(_Controls.TabBorderRight);
    ...
    public class iMainWindow : StandardWindow
    {
        ...
        {
            get => ItemDestructor.ModuleInstance.Selected_Template;
            set
            {
                if (value != null)
                {
        ...
        public iMainWindow(Texture2D background, Rectangle windowRegion, Rectangle contentRegion, TextureManager textureManager, Container parent, Template template) : base(background, windowRegion, contentRegion)
        {
            ...
            Parent = parent;
            _Template = template;
            ItemDestructor.ModuleInstance.Selected_Template = template;
            _EmptyTraitLine = ItemDestructor.TextureManager.getControlTexture(_Controls.PlaceHolder_Traitline).GetRegion(0, 0, 647, 136);
            ...
            _TabBarTexture = ItemDestructor.TextureManager.getControlTexture(_Controls.TabBar_FadeIn);
            _TabBar_Line = ItemDestructor.TextureManager.getControlTexture(_Controls.TabBar_Line);
            ...
            {
                Texture = ItemDestructor.TextureManager.getIcon(_Icons.Bug),
            ...
            ResetButton = new Image()
            {
                ...
                Texture = ItemDestructor.TextureManager.getControlTexture(_Controls.Delete),
            ...
            {
                ResetButton.Texture = ItemDestructor.TextureManager.getControlTexture(_Controls.Delete_Hovered);
            };
            ResetButton.MouseLeft += delegate
            {
                ResetButton.Texture = ItemDestructor.TextureManager.getControlTexture(_Controls.Delete);
            };
            ...
            SaveName = new Image()
            {
                Texture = ItemDestructor.TextureManager.getIcon(_Icons.Checkmark_Color),
                Parent = this,
            ...
            {
                SaveName.Texture = ItemDestructor.TextureManager.getIcon(_Icons.Checkmark_Highlight);

            };
            SaveName.MouseLeft += delegate
            {
                SaveName.Texture = ItemDestructor.TextureManager.getIcon(_Icons.Checkmark_Color);

            };

            CancelName = new Image()
            {
                Texture = ItemDestructor.TextureManager.getIcon(_Icons.Stop_Color),
                Parent = this,
            ...
            {
                CancelName.Texture = ItemDestructor.TextureManager.getIcon(_Icons.Stop_Highlight);
            };
            CancelName.MouseLeft += delegate
            {
                CancelName.Texture = ItemDestructor.TextureManager.getIcon(_Icons.Stop_Color);
            };
        ...
        {
            ItemDestructor.ModuleInstance.Selected_Template = e.Template;
